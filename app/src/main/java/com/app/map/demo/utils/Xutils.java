package com.app.map.demo.utils;
...
public class Xutils {
    private static DbManager db;
     ...
     public static  final String BASE_URL = "http://106.52.198.209:8080/hello/select?code=223&packName=com.flag.jilu";
...
//                .setLoadingDrawableId(R.mipmap.ic_launcher)
    ...
    public interface Getdata{
        public String biaoj(String data);
    }
